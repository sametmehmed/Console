namespace Codility
{
    internal class CyclicRotation
    {
        ...
        public static int[] solution(int[] A, int K)
        {
            ...
            {
                shiftedArray[i] = A[(A.Length - K + i) % A.Length];
            }

            Console.WriteLine("[{0}]", string.Join(", ", shiftedArray));
            return shiftedArray;
        }
        ...
        range[−1,000..1,000]. In your solution, focus on correctness.The performance of your solution will not be the 
